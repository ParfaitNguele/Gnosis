...
export class EngineHandlerService {
  ...
  initEngineForDigit(query_string:string, main_filters:Array<any>, second_filters:Array<any>){
    return this.http.post(this.url.digit_search, JSON.stringify({auth_name:'dise', auth_value:'ONsHZ8fp8299AEQRNFNN', query_string:query_string, main_filters:main_filters, second_filters:second_filters}));
  }
